  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto" style="width: 900px;">
        <li class="nav-item">
          <a class="nav-link active text-white text-bold" aria-current="page" href="/produk">Porduk</a>
        </li>
        <li class="nav-item">
...
@yield('content')
    <script src="assets/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
  </body>
</html>